...
- Выбор форматов ввода и вывода(ASCII/HEX/SCANCODES, для HEX пробел допустим как разделитель, SCANCODES - режим прямой и мгновенной передачи нажатой клавиши на порт)  
- Исправлена ошибка открытия порта выше 9
